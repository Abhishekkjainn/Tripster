...
import 'package:tripster/resultsPages/returnbaggageandcancellation.dart';

class ReturnFlightDetailsReturn extends StatefulWidget {
  final int retind;
  final int onind;
  const ReturnFlightDetailsReturn(
      {super.key, required this.retind, required this.onind});

  @override
  State<ReturnFlightDetailsReturn> createState() =>
      _ReturnFlightDetailsReturnState();
}

class _ReturnFlightDetailsReturnState extends State<ReturnFlightDetailsReturn> {
  ...
  void initState() {
    ...
    returnController.selectedCabinOnward =
        returnController.Cabinbag[widget.retind];
    returnController.selectedCheckinOnward =
        returnController.Baggage[widget.retind];
  ...
  Widget build(BuildContext context) {
    returnController.selectedFareonward =
        returnController.FirstIdentifierAdultTotal[widget.retind];
    ...
    return GetBuilder<ReturnController>(builder: (ReturnController) {
      return Scaffold(
          ...
          bottomNavigationBar: FlightTypebottombarret(widget.retind),
          body: SingleChildScrollView(
            child: Column(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                AllTravelDetailsCard(widget.retind, 2),
                Padding(
                ...
                firstoptiononw(widget.retind),
                (returnController.SecondIdentifiername[widget.retind] == " ")
                    ? Container()
                    : secondoptiononw(widget.retind),
                // Padding(
                //   padding: const EdgeInsets.only(top: 10, left: 20),
                //   child: Text(
                //     "Select Flight (Return)",
  ...
  Container FlightTypebottombarret(index) {
    return Container(
      height: 80,
        ...
        child: Row(
          ...
          children: [
            Row(
              children: [
                Column(
                  ...
                  children: [
                    Text(
                      "Rs " + returnController.selectedFarereturn.toString(),
                      style: TextStyle(
                          color: Colors.black,
                          fontSize: 18,
                          fontWeight: FontWeight.w600),
            ...
            GestureDetector(
              onTap: () {
                Get.to(
                    () => ReturnBaggageandCancellation(
                        onind: widget.retind, retind: widget.retind),
                    ...
                    Row(
                      children: [
                        Radio(
                          ...
                          value: 1,
                          groupValue: returnController.whichFare2,
                          onChanged: (value) {

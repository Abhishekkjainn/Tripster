...
class BaggagePagereturn2 extends StatefulWidget {
  final int onwardkey;
  final int returnkey;
  const BaggagePagereturn2(
      {super.key, required this.onwardkey, required this.returnkey});

  @override
  State<BaggagePagereturn2> createState() => _BaggagePagereturn2State();
}

class _BaggagePagereturn2State extends State<BaggagePagereturn2> {
  ...
  void startErrorTimer() {
    _errorTimer = Timer.periodic(Duration(seconds: 5), (timer) {
      if (mounted) {
        setState(() {
          if (returnReturnController.ThirdCancellationFees2.length == 0) {
          } else {
            firstCancelFare = returnReturnController.ThirdCancellationFees2[0];
          }
        });
      } else {
        _stopErrorTimer();
  ...
  String calcBefore(String todate) {
    DateTime todate =
        DateTime.parse(returnReturnController.ArrDate2[widget.returnkey])
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(
                      calcBefore(returnReturnController
                                  .DepDate2[widget.returnkey])
                              .substring(0, 10) +
                          "  " +
                          calcBefore(returnReturnController
                                  .DepDate2[widget.returnkey])
          ...
          child: Row(
            ...
            children: [
              ClipRRect(
                ...
                child: Image(
                  image: (returnReturnController.AirlineCode2[widget.returnkey]
                              .toString()
                              .toLowerCase() ==
                          '6e')
                      ? const AssetImage('assets/images/indigo.png')
                      : (returnReturnController.AirlineCode2[widget.returnkey]
                                  .toString()
                                  .toLowerCase() ==
                              'uk')
                          ? const AssetImage('assets/images/vistaralogo.png')
                          : (returnReturnController
                                      .AirlineCode2[widget.returnkey]
                                      .toString()
                                      .toLowerCase() ==
                                  'sg')
                  ...
                  children: [
                    ...
                    Text(
                      formatDate(airportController.OnewayDate.toString()
                              .split('T')[0]) +
                          " | " +
                          returnReturnController.DepTime2[widget.returnkey]
                              .toString()
                              .split('T')[1] +
                          " - " +
                          returnReturnController.ArrTime2[widget.returnkey]
                              .toString()
                              .split('T')[1] +
                          " | " +
                          formatDuration(returnReturnController
                              .Duration2[widget.returnkey]) +
                          " | " +
                          returnReturnController.Stops2[widget.returnkey]
                              .toString() +
                          " Stops",
                      style: TextStyle(
                          color: Colors.grey,

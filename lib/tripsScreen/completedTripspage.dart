    ...
    return Scaffold(
      ...
      body: GetBuilder<Bookingcontroller>(
        ...
        builder: (controller) {
          ...
          bool hasUpcomingTrips =
              controller.upcoming.any((trip) => trip == false);
          ...
          if (hasUpcomingTrips) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                if (controller.upcoming[index] == false) {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  AirlineDetails(AirlineCode, AirlineList, AirlineCode2,
                      AirplaneCode, Flightname),
                  DateDuration(
...
Padding AirlineDetails(
    AirlineCode, AirlineList, AirlineCode2, AirplaneCode, Flightname) {
  return Padding(
